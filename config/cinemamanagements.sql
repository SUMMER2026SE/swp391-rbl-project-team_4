...
(N'PAW Patrol: Phim Khủng Long', N'Khi con tàu của PAW Patrol bị cuốn vào một cơn bão bí ẩn, đội cún cứu hộ vô tình lưu lạc đến một hòn đảo nhiệt đới vô danh, nơi sinh sống của nhiều loài khủng long cổ xưa. Họ gặp Rex, một chuyên gia về khủng long, đã mắc kẹt trên hòn đảo này trong nhiều năm. Mọi chuyện trở nên tệ hơn khi Thị trưởng Humdinger, đối thủ không đội trời chung của PAW Patrol rắp tâm khai thác nguồn tài nguyên thiên nhiên tại đây, và vô tình gây ra trận phun trào của một ngọn núi lửa khổng lồ. Đứng trước nguy cơ hòn đảo bị xóa sổ, đội cún cứu hộ phải thực hiện những nhiệm vụ quy mô "khủng" hơn bao giờ hết để ngăn chặn Humdinger và cứu các loài khủng long khỏi nạn tuyệt chủng.', N'Cal Brunker', 0, 'P', 'https://www.youtube.com/watch?v=y7VKkbcz658', 'images/movie_pawpatrol_dino.png', 'Coming Soon', N'Mckenna Grace, Carter Young, Paris Hilton');
GO
...
(13, 6), (13, 2), (13, 1); -- PAW Patrol: Phim Khủng Long: Hoạt hình, Hài, Hành động
GO
-- ═══════════════════ LỊCH CHIẾU ═══════════════════
