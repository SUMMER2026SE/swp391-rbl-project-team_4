-- ╔══════════════════════════════════════════════════════════════════════════╗
-- ║           DATABASE HOÀN CHỈNH - HỆ THỐNG BÁN VÉ RẠP CHIẾU PHIM        ║
-- ║                         D-CINEMA MANAGEMENT                              ║
-- ║  Tương thích 100% với backend Node.js (6 models, 4 controllers)          ║
-- ╚══════════════════════════════════════════════════════════════════════════╝
...
-- ═══════════════════ QUYỀN & TÀI KHOẢN ═══════════════════
INSERT INTO Roles (RoleName) VALUES ('Admin'), ('Manager'), ('Customer');

-- Mật khẩu mặc định: 123456 (bcrypt hash)
INSERT INTO Users (RoleID, FullName, Email, PasswordHash, Phone, IsActive) VALUES
(1, N'Quản Trị Viên',     'admin@dcinema.com',    '$2b$10$g8L1Hk0ukuxE/ePFT272p.quvwGIADo.FHHqmJqQW01vLDk924LLa', '0901111111', 1),
(2, N'Quản Lý Rạp HCM',   'manager@dcinema.com',  '$2b$10$g8L1Hk0ukuxE/ePFT272p.quvwGIADo.FHHqmJqQW01vLDk924LLa', '0902222222', 1),
(3, N'Nguyễn Văn Khách',   'customer@gmail.com',   '$2b$10$g8L1Hk0ukuxE/ePFT272p.quvwGIADo.FHHqmJqQW01vLDk924LLa', '0903333333', 1),
(3, N'Trần Thị Linh',      'linh@gmail.com',       '$2b$10$g8L1Hk0ukuxE/ePFT272p.quvwGIADo.FHHqmJqQW01vLDk924LLa', '0904444444', 1),
(3, N'Lê Hoàng Nam',       'nam@gmail.com',        '$2b$10$g8L1Hk0ukuxE/ePFT272p.quvwGIADo.FHHqmJqQW01vLDk924LLa', '0905555555', 1);
GO
...
-- ═══════════════════ PHIM ═══════════════════
INSERT INTO Movies (Title, Description, Director, Duration, AgeRating, PosterURL, Status, MainCast) VALUES
(N'Neon Horizon',        N'Thế giới tương lai nơi con người sống dưới bầu trời neon rực rỡ.', N'Marcus Thorne',   124, '13+', 'images/movie_neon_dreams.png', 'Now Showing',  N'Chris Evans, Zendaya'),
(N'The Last Echo',       N'Hành trình sinh tồn cuối cùng trong thế giới hậu tận thế.',        N'Sarah Jenkins',   110, '18+', 'images/movie_neon_dreams.png', 'Now Showing',  N'Tom Hardy, Ana de Armas'),
(N'Golden Age',          N'Câu chuyện về kỷ nguyên vàng của điện ảnh Việt Nam.',               N'Trấn Thành',      95,  'P',   'images/movie_neon_dreams.png', 'Now Showing',  N'Trấn Thành, Lê Giang'),
(N'The Odyssey',         N'Thám hiểm vũ trụ tìm kiếm sự sống ngoài Trái Đất.',               N'Christopher Nolan',150, '13+', 'images/movie_neon_dreams.png', 'Now Showing',  N'Matthew McConaughey'),
(N'Midnight Run',        N'Cuộc rượt đuổi đầy hồi hộp giữa thám tử và tên tội phạm.',       N'David Fincher',    118, '16+', 'images/movie_neon_dreams.png', 'Now Showing',  N'Ryan Gosling, Emily Blunt'),
(N'Lật Mặt 8',          N'Phần tiếp theo của loạt phim Lật Mặt nổi tiếng.',                  N'Lý Hải',           130, '13+', 'images/movie_neon_dreams.png', 'Coming Soon',  N'Lý Hải, Trường Giang'),
(N'Avengers: Doomsday',  N'Biệt đội siêu anh hùng đối đầu với mối đe dọa cuối cùng.',       N'Russo Brothers',   180, '13+', 'images/movie_neon_dreams.png', 'Coming Soon',  N'Robert Downey Jr., Scarlett Johansson'),
(N'Inside Out 3',        N'Tiếp tục hành trình cảm xúc đầy màu sắc.',                        N'Pete Docter',      100, 'P',   'images/movie_neon_dreams.png', 'Coming Soon',  N'Amy Poehler');
GO
...
PRINT N'';
PRINT N'══════════════════════════════════════════════════════════════';
PRINT N'  ✅ TẠO DATABASE CinemaManagement THÀNH CÔNG!';
PRINT N'══════════════════════════════════════════════════════════════';
PRINT N'';
PRINT N'  📋 DANH SÁCH 19 BẢNG ĐÃ TẠO:';
PRINT N'  ─────────────────────────────────────────────────────';
PRINT N'   1.  Roles            - Phân quyền';
PRINT N'   2.  Users            - Người dùng';
PRINT N'   3.  PasswordResets   - OTP quên mật khẩu';
PRINT N'   4.  Cinemas          - Cụm rạp';
PRINT N'   5.  Rooms            - Phòng chiếu';
PRINT N'   6.  Seats            - Sơ đồ ghế';
PRINT N'   7.  Movies           - Phim';
PRINT N'   8.  Genres           - Thể loại phim';
PRINT N'   9.  Movie_Genres     - Phim & Thể loại';
PRINT N'  10.  Reviews          - Đánh giá phim';
PRINT N'  11.  Showtimes        - Lịch chiếu';
PRINT N'  12.  FoodBeverages    - Đồ ăn / nước uống';
PRINT N'  13.  Vouchers         - Mã khuyến mãi';
PRINT N'  14.  Tickets          - Vé (Online + Quầy)';
PRINT N'  15.  Ticket_FnB       - F&B đi kèm vé';
PRINT N'  16.  Bookings         - Đơn đặt vé tổng';
PRINT N'  17.  BookingTickets   - Chi tiết vé trong đơn';
PRINT N'  18.  Booking_FnB      - F&B đi kèm đơn';
PRINT N'  19.  ShowtimeSeats    - Trạng thái ghế real-time';
PRINT N'  ─────────────────────────────────────────────────────';
PRINT N'';
PRINT N'  👤 TÀI KHOẢN MẪU (mật khẩu: 123456):';
PRINT N'     Admin:    admin@dcinema.com';
PRINT N'     Manager:  manager@dcinema.com';
PRINT N'     Customer: customer@gmail.com';
PRINT N'';
PRINT N'  🎬 5 phim đang chiếu + 3 phim sắp chiếu';
PRINT N'  🏢 12 cụm rạp + 30 phòng chiếu + 1800 ghế';
PRINT N'  🍿 9 món F&B + 4 mã khuyến mãi';
PRINT N'  🎫 10 giao dịch mẫu cho Dashboard';
PRINT N'══════════════════════════════════════════════════════════════';
